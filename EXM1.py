...
Ib_1 = np.array([ -0.36 , 0.5 ,-0.71 , 1.38 ,1.89 ,-2.33]).reshape(-1,1)
Ib_2 = np.array([-0.36 , 0.5 ,-0.71 , 1.38, 1.79, -2.33]).reshape(-1,1)
...
"""
quantatitive_result = qv.quantatitive_verify(polyOut[0], 1000, polyInp, polyPro, layer, K, W, U, B)
print(quantatitive_result)
"""

"""
polyPro = [[-2,-2], [2,2]]
poly_out = [poly_out[0].point[0], poly_out[0].point[1]]
print(poly_out, polyPro)
quantatitive_result = qv.quantatitive_verify_vr_2(poly_out, polyPro)
print(quantatitive_result)
"""
